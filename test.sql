...
(
 `Student_assessments_id` int NOT NULL ,
...
(
 `Enrollment_plans_id`     int NOT NULL ,
...
(
 `Users_Franchisees_id` int NOT NULL ,
 `Franchisee_id`        int NOT NULL ,
 `User_id`              int NOT NULL ,
...
PRIMARY KEY (`Parent_id`, `Family_account_id`),
KEY `fkIdx_136` (`Family_account_id`),
CONSTRAINT `FK_136` FOREIGN KEY `fkIdx_136` (`Family_account_id`) REFERENCES `Family Account` (`Family_account_id`),
...
-- ************************************** `Family Payment Account`

CREATE TABLE `Family Payment Account`
(
 `Family_payment_id`   int NOT NULL ,
 `Family_account_id`   int NOT NULL ,
...
PRIMARY KEY (`Family_payment_id`, `Family_account_id`),
KEY `fkIdx_130` (`Family_account_id`),
CONSTRAINT `FK_130` FOREIGN KEY `fkIdx_130` (`Family_account_id`) REFERENCES `Family Account` (`Family_account_id`)
);
...
(
 `Enrollment_plans_time_id` int NOT NULL ,
...
PRIMARY KEY (`Emergency_contact_id`, `Family_account_id`),
KEY `fkIdx_156` (`Family_account_id`),
CONSTRAINT `FK_156` FOREIGN KEY `fkIdx_156` (`Family_account_id`) REFERENCES `Family Account` (`Family_account_id`)
);
...
KEY `fkIdx_142` (`Family_account_id`),
CONSTRAINT `FK_142` FOREIGN KEY `fkIdx_142` (`Family_account_id`) REFERENCES `Family Account` (`Family_account_id`),
...
CONSTRAINT `FK_159` FOREIGN KEY `fkIdx_159` (`Student_id`, `Family_account_id`, `Center_id`) REFERENCES `Student Information` (`Student_id`, `Family_account_id`, `Center_id`),
...
PRIMARY KEY (`Enrollment_schedule_id`, `Enrollment_id`, `Student_id_1`, `Family_account_id`, `Student_id`, `Center_id`, `Enrollment_plans_id`),
KEY `fkIdx_169` (`Enrollment_id`, `Student_id_1`, `Family_account_id`, `Center_id`, `Enrollment_plans_id`),
CONSTRAINT `FK_169` FOREIGN KEY `fkIdx_169` (`Enrollment_id`, `Student_id_1`, `Family_account_id`, `Center_id`, `Enrollment_plans_id`) REFERENCES `Student Enrollment Information` (`Enrollment_id`, `Student_id`, `Family_account_id`, `Center_id`, `Enrollment_plans_id`),
KEY `fkIdx_175` (`Student_id`, `Family_account_id`, `Center_id`),
CONSTRAINT `FK_175` FOREIGN KEY `fkIdx_175` (`Student_id`, `Family_account_id`, `Center_id`) REFERENCES `Student Information` (`Student_id`, `Family_account_id`, `Center_id`)
);
...
CONSTRAINT `FK_164` FOREIGN KEY `fkIdx_164` (`Student_id`, `Family_account_id`, `Center_id`) REFERENCES `Student Information` (`Student_id`, `Family_account_id`, `Center_id`),
KEY `fkIdx_186` (`Enrollment_id`, `Student_id`, `Family_account_id`, `Center_id`, `Enrollment_plans_id`),
CONSTRAINT `FK_186` FOREIGN KEY `fkIdx_186` (`Enrollment_id`, `Student_id`, `Family_account_id`, `Center_id`, `Enrollment_plans_id`) REFERENCES `Student Enrollment Information` (`Enrollment_id`, `Student_id`, `Family_account_id`, `Center_id`, `Enrollment_plans_id`)
);
